    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0F172A] px-6 py-12 relative overflow-hidden">
      ...
      <div className="w-full max-w-md z-10">
        <div className="text-center mb-10">
          ...
          <h1 className="font-serif text-4xl font-bold text-white tracking-tight mb-2">Create Shop</h1>
          <p className="text-gray-400 font-medium tracking-wide">Launch your digital atelier</p>
        </div>
        ...
        <div className="bg-white/5 backdrop-blur-2xl border border-white/10 rounded-[40px] p-8 shadow-2xl shadow-black/50">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label className="text-[10px] font-black text-gray-500 uppercase tracking-[0.2em] mb-2 block ml-1">Shop Name</label>
              <input 
                type="text" 
                required
                value={shopName}
